...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'edge-settings') 'First pending ordered target must advance to Edge Settings after To BIOS near-parity acceptance.'
