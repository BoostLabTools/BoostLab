...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'bitlocker') 'First pending ordered target must advance to BitLocker after To BIOS near-parity acceptance.'
