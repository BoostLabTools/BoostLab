...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'driver-install-debloat-settings') 'First pending ordered target must advance past Driver Clean near-parity acceptance.'
