...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'hdcp') 'Current first pending ordered parity target must advance past Nvidia Settings near-parity acceptance.'
