...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'msi-mode') 'Current first pending ordered parity target must advance past P0 State near-parity acceptance.'
