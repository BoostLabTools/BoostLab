...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'nvidia-settings') 'Current first pending ordered parity target must advance past Driver Install Latest near-parity acceptance.'
