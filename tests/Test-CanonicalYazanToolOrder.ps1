...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'p0-state') 'Current first pending ordered parity target must advance past HDCP near-parity acceptance.'
