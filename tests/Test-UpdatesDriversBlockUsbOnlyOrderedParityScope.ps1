...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'to-bios') 'Next ordered pending parity target must advance to To BIOS after Updates Drivers Block final exception.'
