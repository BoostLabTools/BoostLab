...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'driver-install-debloat-settings') 'Ordered parity cursor must advance past Driver Clean near-parity acceptance.'
