...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'driver-install-latest') 'Ordered parity cursor must advance past Driver Install Debloat & Settings near-parity acceptance.'
