...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'nvidia-settings') 'Ordered parity cursor must advance past Driver Install Latest near-parity acceptance.'
