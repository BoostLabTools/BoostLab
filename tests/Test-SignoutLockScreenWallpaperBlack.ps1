...
$protectedModuleHashes = [ordered]@{
    'Windows\ContextMenu.psm1' = '93325E76B02F80B1A105C83F6E268EA3652B4AB9F74582E759A4490CF30D1082'
...
if ($implementedModules.Count -ne 39 -or $placeholderModules.Count -ne 16) {
