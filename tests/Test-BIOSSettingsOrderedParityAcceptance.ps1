...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'nvidia-settings') 'DoneYazanAcceptedNearParity tools and Yazan final exceptions must be skipped by next ordered target calculation.'
