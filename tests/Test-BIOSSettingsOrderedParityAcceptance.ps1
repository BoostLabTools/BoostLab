...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'bitlocker') 'DoneYazanAcceptedNearParity tools and Yazan final exceptions must be skipped by next ordered target calculation.'
