...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'msi-mode') 'DoneYazanAcceptedNearParity tools and Yazan final exceptions must be skipped by next ordered target calculation.'
