...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'p0-state') 'DoneYazanAcceptedNearParity tools and Yazan final exceptions must be skipped by next ordered target calculation.'
