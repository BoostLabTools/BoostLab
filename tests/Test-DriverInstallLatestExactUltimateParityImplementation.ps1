...
foreach ($moduleNeedle in @(
    ...
    'driver-install-latest-nvidia-lookup',
    'driver-install-latest-nvidia-driver-template',
    'driver-install-latest-amd-support-page',
    'driver-install-latest-intel-driver-page',
