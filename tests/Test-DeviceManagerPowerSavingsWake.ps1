...
$protectedHashes = [ordered]@{
    ...
    'modules\Windows\game-bar.psm1' = '48F5D5AB29CE542993AE636E99796511FDC641EB0C6539FEABC144B698698BA0'
    ...
    'modules\Setup\edge-settings.psm1' = 'F57F36BDF9915CDBE63226283227695957E6B232B440CF84568B848567CE93C8'
}
