...
Assert-BoostLabCondition ([string]$nextTarget['ToolId'] -eq 'visual-cpp') 'First pending ordered parity target should advance past Msi Mode near-parity acceptance.'
...
Assert-BoostLabCondition ([int]$parityBaseline.Counts.ManualHandoffOnly -eq 2) 'ManualHandoffOnly baseline count should be 2 after DirectX.'
