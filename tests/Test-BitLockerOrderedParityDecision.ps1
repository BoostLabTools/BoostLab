...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'driver-install-latest') 'Next ordered parity target must advance past Driver Install Debloat & Settings near-parity acceptance.'
