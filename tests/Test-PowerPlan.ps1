...
$protectedModules = [ordered]@{
    ...
    'Copilot' = @{ Path = 'Windows\copilot.psm1'; Hash = '933B6376D702F89662ADF994DBCBD7822BD18FFF1EFA259BFCD5FCF2B8640F5E'; Required = '$script:BoostLabImplementedActions = @(''Apply'', ''Default'')' }
