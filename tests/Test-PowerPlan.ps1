...
$protectedModules = [ordered]@{
    ...
    'GameBar' = @{ Path = 'Windows\game-bar.psm1'; Hash = '48F5D5AB29CE542993AE636E99796511FDC641EB0C6539FEABC144B698698BA0'; Required = '$script:BoostLabImplementedActions = @(''Apply'', ''Default'')' }
