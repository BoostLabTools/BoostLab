...
if ((Get-FileHash -Algorithm SHA256 -LiteralPath $sourcePath).Hash -ne 'B769C351189A3DC2BB8E4A595F9E745A9F25E5A69923DF10619B6D9C34D37724') {
...
foreach ($requiredText in @(
    ...
    'B769C351189A3DC2BB8E4A595F9E745A9F25E5A69923DF10619B6D9C34D37724'
    'Approved by Yazan'
    'newstartmenu.reg'
    'oldstartmenu.reg'
