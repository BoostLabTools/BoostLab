...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'driver-install-latest') 'First ordered pending parity target must advance past Driver Install Debloat & Settings near-parity acceptance.'
