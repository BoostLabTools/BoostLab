...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'edge-settings') 'First ordered pending parity target must advance to Edge Settings after To BIOS near-parity acceptance.'
