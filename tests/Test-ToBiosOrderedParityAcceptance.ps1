...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'nvidia-settings') 'First ordered pending parity target must advance past Driver Install Latest near-parity acceptance.'
