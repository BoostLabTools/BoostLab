...
Assert-BoostLabCondition ([string]$nextTarget.ToolId -eq 'bitlocker') 'First ordered pending parity target must advance to BitLocker after To BIOS near-parity acceptance.'
