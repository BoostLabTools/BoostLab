...
Assert-BoostLabCondition ([string]$firstNonFinal.ToolId -eq 'msi-mode') 'The first ordered pending parity target should advance past P0 State near-parity acceptance.'
