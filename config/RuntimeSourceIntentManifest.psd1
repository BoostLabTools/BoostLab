@{
    ...
    ExternalRuntimeStatus = 'PayloadAndDescriptorSourceIntentReadyPackageSourceReferencesRemain'
    Entries = @{
        'reinstall.source' = @{
            ...
            ExternalModeTreatment = @('OperationDescriptorAvailable', 'ExternalRuntimeDescriptorBacked', 'ExternalRuntimeCanExcludeRawSource', 'DevelopmentOnlySourceParity')
            CustomerVisible = $false
            CurrentInternalSourceRequired = $true
            HighRiskBlocker = $false
            PayloadBlockers = @()
            OperationDescriptorId = 'reinstall-operation-summary'
            OperationDescriptorStatus = 'Available'
            RuntimeWiringStatus = 'DescriptorBackedEvidenceReady'
            ModuleRuntimeWiringStatus = 'NotWired'
            ExternalPackageStatus = 'SourceFreeLaunchBlockedByDirectModuleReferences'
